    ...
    <div class="page">
      <div class="page-content container-fluid">
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          ...
          <div class="col-xs-12 col-xxl-3 col-lg-12">
                    ...
                    <div class="row">
                      <div class="col-xs-6">
                        <div class="counter text-xs-left blue-grey-700">
                          <div class="counter-label m-t-10">Tasks Completed
                          </div>
                ...
                <div class="card card-shadow card-completed-options">
                  <div class="card-block p-30">
                    <div class="row">
                      <div class="col-xs-6">
                        <div class="counter text-xs-left blue-grey-700">
                          <div class="counter-label m-t-10">Points Completed
                          </div>
                          <div class="counter-number font-size-40 m-t-10">
                            698
                          </div>
          ...
          <div class="col-xs-12 col-lg-12 col-xxl-9">
            <div id="teamCompletedWidget" class="card card-shadow example-responsive">
              <div class="card-block p-20 p-b-25">
                <div class="row p-b-40" data-plugin="matchHeight">
                  <div class="col-xs-12 col-md-6 col-sm-12">
                    <div class="counter text-xs-left p-l-10">
          ...
          <!-- Second Row -->
          <!-- Personal -->
          <div class="col-xs-12 col-xxl-4 col-xl-6 col-lg-6">
            <div id="personalCompletedWidget" class="card card-shadow p-b-20">
              <div class="card-header card-header-transparent cover overlay">
                <img class="cover-image" src="{{URL::to('assets/global/photos/placeholder.png')}}">
                <div class="overlay-panel overlay-background vertical-align">
                  <div class="vertical-align-middle">
                    <a class="avatar" href="javascript:void(0)">
                      <img src="{{URL::to('assets/global/portraits/4.jpg')}}"  />
                    </a>
                    <div class="font-size-20 m-t-10">MACHI</div>
          ...
          <!-- To Do List -->
          <div class="col-xs-12 col-xxl-4 col-xl-6 col-lg-6">
            <div id="toDoListWidget" class="card card-shadow p-b-20">
              <div class="card-header card-header-transparent">
                <div class="card-header-actions">
                  <a id="addNewItemBtn" href="javascript:void(0)" class="add-item-toggle pull-xs-right">
              ...
              <ul class="list-group">
                <li class="list-group-item">
                  ...
                  <ul class="item-members">
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/3.jpg')}}"  />
                ...
                <li class="list-group-item">
                  ...
                  <ul class="item-members">
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/1.jpg')}}"  />
                      <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                        <i class="icon wb-pencil" aria-hidden="true"></i>
                      </button>
                    </li>
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/5.jpg')}}"  />
                      <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                        <i class="icon wb-pencil" aria-hidden="true"></i>
                      </button>
                    </li>
                ...
                <li class="list-group-item">
                  ...
                  <ul class="item-members">
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/4.jpg')}}"  />
                      <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                        <i class="icon wb-pencil" aria-hidden="true"></i>
                      </button>
                    </li>
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/6.jpg')}}"  />
                      <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                        <i class="icon wb-pencil" aria-hidden="true"></i>
                      </button>
                    </li>
                    <li>
                      <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/7.jpg')}}"  />
                      <button class="btn btn-sm btn-icon btn-default btn-outline btn-round">
                        <i class="icon wb-pencil" aria-hidden="true"></i>
                      </button>
                    </li>
          ...
          <!-- End To Do List -->
          <!-- Recent Activity -->
          <div class="col-xs-12 col-xxl-4 col-md-12">
            <div id="recentActivityWidget" class="card card-shadow p-b-20">
              <div class="card-header card-header-transparent">
                <span class="tag tag-default tag-round pull-xs-right">VIEW ALL</span>
                <h5 class="card-title">
                  RECENT ACTIVITY
                </h5>
              </div>
                  ...
                  <div class="timeline-content-wrap">
                    ...
                    <div class="timeline-content">
                      ...
                      <ul class="members">
                        ...
                        <li>
                          <img class="avatar avatar-sm" src="{{URL::to('assets/global/portraits/8.jpg')}}"  />
                        </li>
                      </ul>
                    </div>
                  </div>
